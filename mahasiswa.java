...
public class mahasiswa extends tampilan implements nilai{
    ...
    public void tambahData() throws SQLException {
    	...
    	try {
	        ...
	        // Pengolahan Database (CRUD)
	        String sql = "INSERT INTO nilai_siswa (nim_mahasiswa, nama_mahasiswa, nilai_tugas, 	nilai_uts, nilai_uas, nilai_akhir, grade) VALUES ('"+nimMahasiswa+"','"+namaMahasiswa+"','"+nilaiTugas+"','"+nilaiUTS+"','"+nilaiUAS+"','"+nilaiAkhir+"','"+gradeNilai+"')";
	...
	public void ubahData() throws SQLException{
		...
		try {
            ...
            // Pengolahan Database (CRUD)
            String sql = "SELECT * FROM nilai_siswa WHERE nim_mahasiswa = " +nimMahasiswa;
            conn = DriverManager.getConnection(url,"root","");
            Statement statement = conn.createStatement();
            ...
            if(result.next()){
                ...
                // Pengolahan Database (CRUD)
                sql = "UPDATE nilai_siswa SET nama_mahasiswa='"+namaMahasiswa+"' WHERE nim_mahasiswa='"+nimMahasiswa+"'";
	...
	public void hapusData() {
		...
		try{
	        ...
	        // Pengolahan Database (CRUD)
	        String sql = "DELETE FROM nilai_siswa WHERE nim_mahasiswa = "+ nimMahasiswa;
	        conn = DriverManager.getConnection(url,"root","");
	        Statement statement = conn.createStatement();
